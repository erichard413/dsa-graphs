...
describe("BFS", function() {
  ...
  describe("hasCycle", function (){
    it("should return true if the graph contains a cycle", function() {
      const homer = new Node('home simpson');
      const marge = new Node('marge simpson');
      const maggie = new Node('maggie simpson');
      const lisa = new Node('lisa simpson');
      const grampa = new Node('grampa simpson');
      const friends = new Graph();
      friends.addVertices([homer, marge, maggie, lisa, grampa])
      ...
      friends.addEdge(lisa, grampa);
      expect(friends.hasCycle()).toBe(true);
    })
    it("should return false if the graph does not contain a cycle", function() {
      const homer2 = new Node('home simpson');
      const marge2 = new Node('marge simpson');
      const maggie2 = new Node('maggie simpson');
      const lisa2 = new Node('lisa simpson');
      const grampa2 = new Node('grampa simpson');
      const friends2 = new Graph();
      friends2.addVertices([homer2, marge2, maggie2, lisa2, grampa2])
      friends2.addEdge(homer2, marge2);
      friends2.addEdge(marge2, maggie2);
      friends2.addEdge(maggie2, lisa2);
      friends2.addEdge(lisa2, grampa2);
      expect(friends2.hasCycle()).toBe(false);
    })
});
describe("shortestPath", function(){
  it("accepts a graph, a source vertex and target vertex and returns the shortest path", function(){
    let graph = new Graph();
    let S = new Node("S");
    let P = new Node("P");
    let U = new Node("U");
